    ...
    <Section
      ...
      renderNew={() => creatingSan && (
        <tr className="bg-green-50">
          ...
          <td><input type="number" value={newSanData.user_id} onChange={e => setNewSanData({...newSanData, user_id: +e.target.value})} className="border px-1 py-0.5 w-full" /></td>
          <td><input type="text" value={newSanData.motivo} onChange={e => setNewSanData({...newSanData, motivo: e.target.value})} className="border px-1 py-0.5 w-full" /></td>
          <td><input type="date" value={newSanData.fecha_inicio} onChange={e => setNewSanData({...newSanData, fecha_inicio: e.target.value})} className="border px-1 py-0.5 w-full" /></td>
          <td><input type="date" value={newSanData.fecha_fin} onChange={e => setNewSanData({...newSanData, fecha_fin: e.target.value})} className="border px-1 py-0.5 w-full" /></td>
